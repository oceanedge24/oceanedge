...
SECRET_KEY = 'django-insecure-9@h8i_%u++!(7c)_awh0y9gq_qj15jf)4w&%!e$z9)w_og7fh7'
...
WSGI_APPLICATION = 'vampy.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    ...
    'account.backend.EmailOrMobileBackend',
